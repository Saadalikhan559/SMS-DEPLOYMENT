...
export const AdmissionFees = () => {
  ...
  // ----- Auto-set default amount but allow manual override -----
  useEffect(() => {
  ...
  // ----- FIXED: Submit with partial payment support -----
  const onSubmit = async (data) => {
    ...
    // Check for advance payment (only if amount is greater than total)
  ...
  const processPayment = async (paymentMode, chequeNumber, schoolYearId, paidAmount, annualSelected, monthlySelected, data, advanceAdjustment = null) => {
    ...
    // Annual fees - distribute paid amount
    ...
    // Monthly fees - distribute remaining amount
