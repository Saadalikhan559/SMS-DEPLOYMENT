...
export const DocumentUpload = () => {
  ...
  const generateTcImage = async () => {
    ...
    try {
      ...
      y = drawText(`Form No. ${tcFormData.form_no || '4'}`, leftMargin, y, 16, true, 'center');
      y = drawText(tcFormData.tc_no || '02', leftMargin, y, 14, false, 'center');
      y = drawText('TRANSFER CERTIFICATE', leftMargin, y, 18, true, 'center');
      y = drawText(`No. ................. Scholar No. ${tcFormData.scholar_no || '.................'}`, leftMargin, y, 13, false, 'center');
